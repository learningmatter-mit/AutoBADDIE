...
def clean_workdir(WORKDIR):
    ...
    paths.append(os.path.join(WORKDIR, 'trained_AutoBADDIE_FF.json'))
    paths.append(os.path.join(WORKDIR, 'output_lammps_data_file.lmp'))
    paths.append(os.path.join(WORKDIR, 'AutoBADDIE.data'))
    paths.append(os.path.join(WORKDIR, 'AutoBADDIE.json'))
